...
const walkabilityData = [
  { center: [48.8566, 2.3522], radius: 1000, score: 90, color: '#4ade80' }, // 1st arrondissement
  { center: [48.8728, 2.3378], radius: 800, score: 85, color: '#86efac' },  // 9th arrondissement
  { center: [48.8534, 2.3751], radius: 900, score: 80, color: '#bbf7d0' },  // 11th arrondissement
  { center: [48.8448, 2.3505], radius: 700, score: 75, color: '#d9f99d' },  // 5th arrondissement
  { center: [48.8673, 2.2898], radius: 1200, score: 65, color: '#fef08a' }, // 16th arrondissement
  { center: [48.8703, 2.3072], radius: 1100, score: 70, color: '#fde047' }  // 8th arrondissement
];

// Sample accessibility data (would come from 15mincity.ai API)
const accessibilityData = {
  schools: [
    { position: [48.8546, 2.3470], radius: 500, score: 95 },
    { position: [48.8670, 2.3210], radius: 450, score: 90 },
    { position: [48.8490, 2.3380], radius: 600, score: 85 }
  ],
  groceries: [
    { position: [48.8566, 2.3500], radius: 600, score: 90 },
    { position: [48.8700, 2.3400], radius: 500, score: 85 },
    { position: [48.8530, 2.3700], radius: 550, score: 80 }
  ],
  healthcare: [
    { position: [48.8580, 2.3450], radius: 700, score: 85 },
    { position: [48.8650, 2.3300], radius: 650, score: 80 },
    { position: [48.8510, 2.3650], radius: 800, score: 75 }
  ]
};
      ...
      Object.entries(accessibilityData).forEach(([type, locations]) => {
        locations.forEach(location => {
          const circle = L.circle(location.position, {
            ...
            color: accessibilityColors[type],
            fillOpacity: 0.3,
            weight: 1
