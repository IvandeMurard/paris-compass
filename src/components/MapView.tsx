...
import MapPanelCard from './MapPanelCard';
  ...
  return (
    <div className="relative h-full w-full bg-muted/40">
      ...
      <div className="absolute left-4 top-4 flex flex-col gap-2 z-[1000]">
        <Button variant="secondary" size="icon" aria-label={t('map.zoomIn')} onClick={handleZoomIn} className="bg-background hover:bg-muted shadow-sm">
          <ZoomIn className="h-4 w-4 text-foreground" />
        </Button>
        <Button variant="secondary" size="icon" aria-label={t('map.zoomOut')} onClick={handleZoomOut} className="bg-background hover:bg-muted shadow-sm">
          <ZoomOut className="h-4 w-4 text-foreground" />
        </Button>
        <Button variant="secondary" size="icon" aria-label={t('map.locate')} onClick={handleLocate} className="bg-background hover:bg-muted shadow-sm">
          <Locate className="h-4 w-4 text-foreground" />
        </Button>
        <Button variant="secondary" size="icon" aria-label={t('map.reset')} onClick={handleResetView} className="bg-background hover:bg-muted shadow-sm">
      ...
      <div className="absolute top-4 right-4 z-[1000] w-56">
        <MapPanelCard title={t('map.layers')}>
      ...
      <div className="absolute bottom-4 right-4 z-[1000] max-w-xs">
        <MapPanelCard title={t('map.env.title')}>
