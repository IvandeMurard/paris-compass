...
| Filosofi carroyé 200 m | INSEE | ingérée — migration préparée le 8/09/2026, non posée | Licence Ouverte 2.0 (`lov2`, mesurée le 8/09/2026) | carreau 200 m | Revenu et population sur une maille qui sépare deux rues. | L'IRIS est trop large — ne pas s'en contenter. **Ne publie aucune médiane à cette maille** : seule une somme winsorisée existe (`ind_snv`), d'où une MOYENNE estimée par habitant, jamais une médiane — voir la migration `20260908000001` et `docs/tickets/w2-filosofi.md`. |
