...
| Issues | **39 ouvertes, 18 fermées** — remesuré par `gh` le 27 août à 19 h 33 UTC, après fermeture de [`#61`](https://github.com/IvandeMurard/paris-compass/issues/61) et ouverture de [`#62`](https://github.com/IvandeMurard/paris-compass/issues/62) le même jour. Il valait 40/17 dix minutes plus tôt : **remesurer avant de recopier** |
