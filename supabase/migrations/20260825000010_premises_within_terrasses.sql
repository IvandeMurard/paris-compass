-- Exposes terrasse authorisation status on the same RPC that already carries the PLU and
-- chantier facts — w1-terrasses (issue #15). Same reasoning as 20260825000005 and
-- 20260825000008: the fiche restauration reading "oui/non/inconnu terrasse, avec le type"
-- is a Lovable change once the RPC carries the facts, not another round trip.
--
